...
## Defining counties for analysis
## Counties includes: Cobb, DeKalb, Fulton, Gwinnett, and Clayton
...
## Getting specific dates and times
# df length = ~90,000
...
## Looking at total Covid cases per day
daily = finaldf
len(daily)
